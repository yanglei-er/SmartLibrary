...
{
    public partial class UserManage : INavigableView<UserManageViewModel>
    {
        private readonly FaceInfoSimple faceInfo = new(string.Empty, string.Empty, string.Empty, string.Empty, string.Empty);

        public UserManageViewModel ViewModel { get; }

        public UserManage(UserManageViewModel viewModel)
        {
            ViewModel = viewModel;
            DataContext = this;
            InitializeComponent();
