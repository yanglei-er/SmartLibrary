...
namespace SmartLibrary.ViewModels
{
    public partial class AddUserViewModel : ObservableObject, INavigationAware
    {
        ...
        public AddUserViewModel(INavigationService navigationService, ISnackbarService snackbarService, IContentDialogService contentDialogService)
        {
        ...
        private void CloseCamera(System.Windows.Controls.Image image, System.Windows.Controls.Image maskImage)
        {
            ...
            dispatcherTimer.Tick += (_, _) =>
            {
                ...
                maskImage.Source = ImageProcess.StringToBitmapImage(string.Empty); 
        ...
        public async void AddFace()
        {
            ...
            if (FaceList.Count < 3)
            {
                ...
                {
                    Title = "录入人脸",
                    Content = "您的人脸图片数据太少(<3)，可能会导致识别结果精确度下降，是否继续添加？",
                    PrimaryButtonText = "是",
                    CloseButtonText = "否",
